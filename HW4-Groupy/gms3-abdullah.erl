...
leader(Id, Master, N, Slaves, Group) ->
  receive
    ...
    {join, Wrk, Peer} ->
      ...
      bcast(Id, {view, N, [self()|Slaves2], Group2}, Slaves2), % broadcast the new view = here self is the leader pid
